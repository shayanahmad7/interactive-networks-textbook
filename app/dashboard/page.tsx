...
const chatMap = [
  ...
  // Chapter 2
  "10", // 2.1 Principles of Network Applications
  "11", // 2.2 The Web and HTTP
  "12", // 2.3 Electronic Mail in the Internet
  "13", // 2.4 DNS—The Internet's Directory Service
  "14", // 2.5 Peer-to-Peer File Distribution
  "15", // 2.6 Video Streaming and Content Distribution Networks
  "16", // 2.7 Socket Programming: Creating Network Applications
  "17", // 2.8 Summary
  // Chapter 3
  "18", // 3.1 Introduction and Transport-Layer Services
  "19", // 3.2 Multiplexing and Demultiplexing
  "20", // 3.3 Connectionless Transport: UDP
  "21", // 3.4 Principles of Reliable Data Transfer
  "22", // 3.5 Connection-Oriented Transport: TCP
  "23", // 3.6 Principles of Congestion Control
  "24", // 3.7 TCP Congestion Control
  "25", // 3.8 Evolution of Transport-Layer Functionality
  "26", // 3.9 Summary
  // Chapter 4
  "27", // 4.1 Overview of Network Layer
  "28", // 4.2 What's Inside a Router?
  "29", // 4.3 The Internet Protocol (IP): IPv4, Addressing, IPv6, and More
  "30", // 4.4 Generalized Forwarding and SDN
  "31", // 4.5 Middleboxes
  "32", // 4.6 Summary
  // Chapter 5
  "33", // 5.1 Introduction
  "34", // 5.2 Routing Algorithms
  "35", // 5.3 Intra-AS Routing in the Internet: OSPF
  "36", // 5.4 Routing Among the ISPs: BGP
  "37", // 5.5 The SDN Control Plane
  "38", // 5.6 ICMP: The Internet Control Message Protocol
  "39", // 5.7 Network Management and SNMP, NETCONF/YANG
  "40", // 5.8 Summary
  // Chapter 6
  "41", // 6.1 Introduction to the Link Layer
  "42", // 6.2 Error-Detection and -Correction Techniques
  "43", // 6.3 Multiple Access Links and Protocols
  "44", // 6.4 Switched Local Area Networks
  "45", // 6.5 Link Virtualization: A Network as a Link Layer
  "46", // 6.6 Data Center Networking
  "47", // 6.7 Retrospective: A Day in the Life of a Web Page Request
  "48", // 6.8 Summary
  // Chapter 7
  "49", // 7.1 Introduction
  "50", // 7.2 Wireless Links and Network Characteristics
  "51", // 7.3 WiFi: 802.11 Wireless LANs
  "52", // 7.4 Cellular Networks: 4G and 5G
  "53", // 7.5 Mobility Management: Principles
  "54", // 7.6 Mobility Management in Practice
  "55", // 7.7 Wireless and Mobility: Impact on Higher-Layer Protocols
  "56", // 7.8 Summary
  // Chapter 8
  "57", // 8.1 What Is Network Security?
  "58", // 8.2 Principles of Cryptography
  "59", // 8.3 Message Integrity and Digital Signatures
  "60", // 8.4 End-Point Authentication
  "61", // 8.5 Securing E-Mail
  "62", // 8.6 Securing TCP Connections: TLS
  "63", // 8.7 Network-Layer Security: IPsec and Virtual Private Networks
  "64", // 8.8 Securing Wireless LANs and 4G/5G Cellular Networks
  "65", // 8.9 Operational Security: Firewalls and Intrusion Detection Systems
  "66"  // 8.10 Summary
];
